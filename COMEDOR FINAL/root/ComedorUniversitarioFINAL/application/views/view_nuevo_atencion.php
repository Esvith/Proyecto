...
<?php
	...
	'id'          => 'carrera',
	'size'        => 50,
	'value'		  => set_value('carrera',$hoy = date("Y-m-d") ),
	'placeholder' => 'Carrera',
	'type'        => 'text',
	'readonly'        => 'readonly',
	);
	...
	echo '<td>';
	echo form_input($hoy = date("Y-m-d") );
	echo '</td>';
...
echo($hoy = date("Y-m-d") );
 ...
 $fecha_atencion 	  = array(
	...
	'id'          => 'facultad',
	'size'        => 50,
	'value'		  => set_value('facultad',$hoy = date("Y-m-d") ),
	'placeholder' => 'Facultad',
	'type'        => 'text',

	);
	echo '<tr>';
	echo '<td>'.form_label("FECHA",'facultad').'</td>';
	echo '<td>';
	echo form_input($hoy = date("Y-m-d") );
	echo '</td>';
	echo '<td><font color="red">'.form_error('facultad').'</font></td>';
	...
	echo '<input type="submit" class="btn btn-success" value="REGISTRAR ATENCION">';
    echo '</center></td></tr>';
    echo '</table></center>';
    echo form_close(); 
    echo '</td></tr>';
